<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="问诊时间" prop="wenzhenshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wenzhenshijian" label="问诊时间" prop="wenzhenshijian">
              <el-input v-model="ruleForm.wenzhenshijian" 
                placeholder="问诊时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="问诊内容" prop="wenzhenneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="问诊内容"
                  v-model="ruleForm.wenzhenneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wenzhenneirong" label="问诊内容" prop="wenzhenneirong">
                    <span>{{ruleForm.wenzhenneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yishengxingming = true;
          ...
          if(o=='wenzhenneirong'){
            this.ruleForm.wenzhenneirong = obj[o];
	    this.ro.wenzhenneirong = true;
            continue;
          }
          if(o=='wenzhenshijian'){
