<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医院类型" prop="yiyuanleixing">
          <el-select v-model="ruleForm.yiyuanleixing" placeholder="请选择医院类型">
            <el-option
                v-for="(item,index) in yiyuanleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="医院类型" prop="yiyuanleixing">
	      <el-input v-model="ruleForm.yiyuanleixing"
                placeholder="医院类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yiyuantupian" label="医院图片" prop="yiyuantupian">
          <file-upload
          tip="点击上传医院图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.yiyuantupian?ruleForm.yiyuantupian:''"
          @change="yiyuantupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.yiyuantupian" label="医院图片" prop="yiyuantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yiyuantupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiyuanmingcheng = true;
          ...
          if(o=='yiyuanleixing'){
            this.ruleForm.yiyuanleixing = obj[o];
	    this.ro.yiyuanleixing = true;
            continue;
          }
          if(o=='yiyuantupian'){
            this.ruleForm.yiyuantupian = obj[o];
	    this.ro.yiyuantupian = true;
            continue;
          }
          if(o=='lianxiren'){
    ...
    yiyuantupianUploadChange(fileUrls) {
	this.ruleForm.yiyuantupian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
