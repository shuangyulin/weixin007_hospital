    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="问诊回复" prop="wenzhenhuifu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="问诊回复"
                  v-model="ruleForm.wenzhenhuifu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wenzhenhuifu" label="问诊回复" prop="wenzhenhuifu">
                    <span>{{ruleForm.wenzhenhuifu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='wenzhenhuifu'){
            this.ruleForm.wenzhenhuifu = obj[o];
	    this.ro.wenzhenhuifu = true;
            continue;
          }
          if(o=='huifushijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wenzhenhuifu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wenzhenhuifuCrossAddOrUpdateFlag = false;
                  this.parent.search();
