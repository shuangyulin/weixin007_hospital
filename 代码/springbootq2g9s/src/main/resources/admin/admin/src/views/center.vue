  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yisheng'"  label="账号" prop="zhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yisheng'"  label="电话" prop="dianhua">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.zhanghao)&& 'yisheng'==this.flag){
      ...
      if( 'yisheng' ==this.flag && this.ruleForm.dianhua&&(!isMobile(this.ruleForm.dianhua))){
