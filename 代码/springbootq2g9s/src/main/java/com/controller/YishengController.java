...
public class YishengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YishengEntity user = yishengService.selectOne(new EntityWrapper<YishengEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody YishengEntity yisheng){
    	...
    	YishengEntity user = yishengService.selectOne(new EntityWrapper<YishengEntity>().eq("zhanghao", yisheng.getZhanghao()));
		if(user!=null) {
